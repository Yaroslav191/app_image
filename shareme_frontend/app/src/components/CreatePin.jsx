...
function CreatePin({ user }) {
    ...
    const uploadImage = (e) => {
        ...
        if (
            ...
            client.assets
                ...
                .catch((error) => {
                    console.log('image ipload error', error);
                });
        } else {
    ...
    mt-5 lg:h-4/5">
            ...
            bg-white lg:p-5 p-3 lg:w-4/5 w-full">
                <div
                    className="bg-secondaryColor p-3 flex
                flex-0.7 w-full">
                    <div
                        ...
                        {!imageAsset ? (
                            ...
                            <div className="relative h-full">
                                ...
                                <button
                                    ...
                                    right-3 p-3 rounded-full bg-white text-xl cursor-pointer
                ...
                <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
                    ...
                    <input
                        ...
                        className="outline-none text-base sm:text-lg  border-b-2
                            border-gray-200 p-2"
                    />
                    <input
                        type="text"
